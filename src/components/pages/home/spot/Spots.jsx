          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <CardSpots 
                ...
                title={"Lake Serenity"} 
                description={"Perfect for bass and trout fishing with calm waters and scenic views."}/>
              
              <CardSpots 
                image={"https://images.unsplash.com/photo-1531517765038-ee4843460f44?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80"} 
                title={"River Rapids"} 
                description={"Challenging spot for salmon and steelhead with strong currents."}/>
              ...
              <CardSpots 
                ...
                description={"Offshore fishing for marlin, tuna, and other big game fish."}/>
