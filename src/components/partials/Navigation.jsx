    ...
    <>
      ...
      >
        <div className="flex flex-col items-center space-y-8 text-white text-2xl">
          <a href="#home" className="hover:text-blue-200 transition" onClick={() => setIsMenuOpen(false)}>
            Home
          </a>
          <a href="#spots" className="hover:text-blue-200 transition" onClick={() => setIsMenuOpen(false)}>
            Fishing Spots
          </a>
          <a href="#gear" className="hover:text-blue-200 transition" onClick={() => setIsMenuOpen(false)}>
            Gear Guide
          </a>
          <a href="#tips" className="hover:text-blue-200 transition" onClick={() => setIsMenuOpen(false)}>
            Tips
          </a>
          <a href="#contact" className="hover:text-blue-200 transition" onClick={() => setIsMenuOpen(false)}>
            Contact
          </a>
      </div>
    </div>
